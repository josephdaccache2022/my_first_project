...
# (str) Package name
package.name = feetApp

# (str) Package domain (needed for android/ios packaging)
package.domain = com.feetApp
...
requirements = python3,kivy,pillow,pyjnius==master
...
[app@x86_64]
android.arch = x86_64
build_dir = .buildozer/build/x86_64/
[app@x86]
android.arch = x86
build_dir = .buildozer/build/x86/
[app@arm64-v8a]
android.arch = arm64-v8a
build_dir = .buildozer/build/arm64-v8a/
